...
module.exports = [
  ...
  {
    name: "Waimea Table Tennis Club",
    id: "waimea-ttc",
    address: "65-1260 Kawaihae Rd, Waimea, HI 96743",
    pricePerDay: "$0",
  ...
  {
    name: "Captain Cook Table Tennis Club",
    id: "captain-cook-ttc-kona",
    address: "Yano Hall, 82-6156 Mamalahoa Highway, Captain Cook, HI 96740",
    website: "http://www.tabletennisandmore.com/captaincookclub.htm",
    facebook: "https://www.facebook.com/tabletennishawaii/",
    pricePerDay: "$0",
    lat: 19.489435267945,
    lng: -155.91051588730232,
    traits: {
      [CT.PERMANENCE]: 0,
      [CT.HOURS]: 0,
      [CT.CEILINGS]: 1,
  ...
  {
    name: "Kona Table Tennis Club",
    id: "kona-ttc",
    address: "Kekuaokalani Gymnasium, 75-5500 Kuakini Hwy",
    website: "https://konapong.wixsite.com/kttc",
    pricePerDay: "$0",
    lat: 19.640985837434336,
    lng: -156.00211952777997,
    traits: {
      [CT.PERMANENCE]: 0,
      [CT.HOURS]: 0,
      [CT.CEILINGS]: 0,
  ...
  {
    name: "Big Island Table Tennis Association",
    id: "big-island-tta",
    pricePerDay: "$5",
    website: "http://bitta.org/",
    facebook: "https://www.facebook.com/join.bitta/",
    address: "Island of Hawaii YMCA, 300 W Lanikaula St, Hilo, HI 96720",
    lat: 19.7049808,
    lng: -155.0799355206924,
    images: [
      "http://bitta.org/sites/default/files/TT%20Nov%202015%20Tourney%20Kids%20and%20Women-05882.jpg",
    ],
    traits: {
      [CT.PERMANENCE]: 0,
      [CT.HOURS]: 1,
  ...
  {
    name: "Beretania District Park",
    id: "beretania-district-park",
    address: "Beretania District Park, 1290 Aala St",
    lat: 21.320030389601843,
    lng: -157.86233739648122,
    pricePerDay: "$0",
    traits: {
      [CT.PERMANENCE]: 0,
      [CT.HOURS]: 2,
  ...
  {
    name: "The Honolulu Club",
    id: "honolulu-club",
    website: "https://www.honoluluclub.com/",
    address: "932 Ward Avenue, 7th Floor, Honolulu, HI 96814",
    lat: 21.302015181692738,
    lng: -157.85090254494372,
    pricePerDay: "$25",
    phone: "808-688-3356",
    traits: {
      [CT.PERMANENCE]: 0,
  ...
  },
  {
    name: "Kilauea Gym",
    id: "kilauea-gym",
    address: "Kilauea Gym, 4109 Kilauea Ave",
    lat: 21.269467650416047,
    lng: -157.79501311280106,
    pricePerDay: "$0",
    phone: "(808) 733-7356",
    traits: {
      [CT.PERMANENCE]: 0,
  ...
  {
    name: "Manoa District Park",
    id: "manoa-district-park",
    address: "Manoa District Park, room off side of main gym, 2721 Kaaipu Ave",
    lat: 21.31705737577409,
    lng: -157.8079623231961,
    pricePerDay: "$0",
    phone: "(808) 988-0513",
    traits: {
      [CT.PERMANENCE]: 0,
  ...
  {
    name: "Newtown Rec Center",
    id: "newtown-rec-center",
    address: "98-456 Kaahele St",
    lat: 21.39823098197438,
    lng: -157.94745114494208,
    pricePerDay: "$3",
    phone: "(808) 728-7927",
    traits: {
      [CT.PERMANENCE]: 0,
  ...
  },
  {
    ...
    id: "waipahu-district",
    address: "94-230 Paiwa St, Waipahu, HI 96797",
    lat: 21.38745767599195,
    lng: -157.99912572960014,
    pricePerDay: "$0",
    phone: "(808) 675-7129",
    traits: {
      [CT.PERMANENCE]: 0,
  ...
  },
  {
    ...
    id: "waikiki-community-center",
    address: "310 Paoakalani Ave, Honolulu, HI 96815",
    lat: 21.275444750415403,
    lng: -157.82019084309533,
    pricePerDay: "$5",
    phone: "(808) 923-1802",
    traits: {
      [CT.PERMANENCE]: 0,
  ...
  },
  {
    name: "Lanai Gym",
    id: "lanai-gym",
    address: "717 Fraser Ave, Lanai City, HI 96763",
    lat: 20.825066288840084,
    lng: -156.92194450262303,
    phone: "(808) 565-6979",
    traits: {
      [CT.PERMANENCE]: 0,
      [CT.HOURS]: 0,
